...
class _HomeTopRandomState extends State<HomeTopRandom> {
  ...
  Future _obtainTopRandomFuture() => Provider.of<HomeTopRandomAnimal>(context, listen: false).getData();
              ...
              builder: ((context, futureAnimal, child) {
                ...
                return Stack(
                  children: [
                    Container(
                      height: MediaQuery.of(context).size.height,
                      child: topRandomAnimal.imageLinks.isNotEmpty? Image.network(topRandomAnimal.imageLinks[0], fit: BoxFit.cover,) :
                    ...
                    Positioned(
                      ...
                      child: Row(
                        children: [
                          ...
                          FavoriteButton(title: 'title', currentAnimal: topRandomAnimal,)
                        ],
                      ),
                    ),
                  ],
